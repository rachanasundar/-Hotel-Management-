...
<body>
	<%
	Object result = request.getAttribute("objUpdateIName");
	if (result != null) {
		out.print(result + "<br>");
	}
	%>
	...
	<div align="center">
		...
		<a href="/admin/adminHome"><button class="btn1">Home</button></a> <a
			...
			href="/menu/updateItemPricePage"><button class="btn1">Update Item
				Price</button></a> <a href="/menu/deleteItemPage"><button class="btn1">Delete
				Item</button></a>
	
	<h2>Update Item Name</h2>
	<form action="/menu/updateItemName" method="post">
		<label>Item Id-----------------</label>
